  ...
  return (
    <form className="flex flex-col gap-8 pb-10" onSubmit={onUpdateSettings}>
      <div className="flex flex-col gap-3">
        <h2 className="font-bold text-2xl">Configurações de domínio</h2>
      ...
      <div className="flex flex-col gap-3 mt-5">
        <div className="flex gap-4 items-center">
          <h2 className="font-bold text-2xl">Configurações do chatbot</h2>
      ...
      <div className="flex gap-5 justify-end mr-10">
        ...
        >
          <Loader loading={deleting}>Excluir domínio</Loader>
        </Button>
