  ...
  return (
    <div className={`${className}`}>
      <h2 className="flex items-center space-x-2 p-2">
        ...
        <span className="text-blue opacity-70">|</span>
        <span
          className="text-blue font-extrabold"
          style={{ fontSize: `${size * 0.6}px` }}
        >
          Chat
        </span>
...
const LogoSidebarClose: React.FC<LogoSidebarCloseProps> = ({
  className = '',
  size = 32,
  onClick,
}) => {
      ...
      <div className={`cursor-pointer ${className}`}>
        <h2 className="flex items-center space-x-4 p-4">
          ...
          <div className="flex flex-col items-start">
            <span className="text-gray-900 dark:text-white font-extrabold text-4xl">
              Avontz
            </span>
            <div className="flex space-x-2">
              <span className="text-blue-600 opacity-90 text-3xl font-semibold">
                Chat
              </span>
            </div>
          </div>
